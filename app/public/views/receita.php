...
<p class="text-slate-500 text-sm font-medium">Total Recebido no Mês</p>
</div>
...
<h3 class="font-bold text-lg">Histórico de Receitas</h3>
    ...
    <?php foreach ($receitas as $receita): ?>
        <tr class="hover:bg-slate-50/50 dark:hover:bg-slate-800/20 transition-colors">
            ...
            <td class="px-6 py-4 text-right">
                <a href="?page=receita&action=editar&id=<?= $receita['id'] ?>"
